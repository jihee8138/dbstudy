...
-- 1. (비상관 쿼리) 부서번호가 50인 부서에 근무하는 사원의 사원번호, 사원명, 부서명 조회하시오.
SELECT EMPLOYEE_ID
     , LAST_NAME
     , (SELECT DEPARTMENT_NAME
          FROM DEPARTMENTS
         WHERE DEPARTMENT_ID = 50) --DEPARTMENT_ID가 PK이기 때문에 이 서브 쿼리는 단일행
  FROM EMPLOYEES
 WHERE DEPARTMENT_ID = 50;
 
-- 2. (상관 쿼리) 부서번호가 50인 부서에 근무하는 사원의 사원번호, 사원명, 부서명 조회하시오.
