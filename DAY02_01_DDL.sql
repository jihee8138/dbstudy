...
/*
    ...
    5. 테이블 이름 바꾸기 : ALTER TABLE 테이블명 RENAME TO     신규테이블
*/

-- 1. BANK_T에 연락처(BANK_TEL) 칼럼을 추가하시오.
        ALTER TABLE BANK_T ADD BANK_TEL VARCHAR2(15 BYTE); --NULL, NOT NULL은 선택사항임.
...
-- 5. CUSTOMER_T에 등급(GRADE) 칼럼을 추가하시오. 'VIP', 'GOLD', 'SILVER', 'BRONZE' 중 하나의 값을 가지도록 설정하시오.
        ALTER TABLE CUSTOMER_T ADD GRADE VARCHAR2(6 BYTE) CHECK(GRADE= 'VIP' OR GRADE='SILVER' OR GRADE='BRONZE');
